;;; private/lubricy/+commands.el -*- lexical-binding: t; -*-
...
(ex! "q"            #'+workspace/close-window-or-workspace)   ; TODO Test me
(ex! "al[ign]"      #'+evil:align)
...
(ex! "k[ill]all"   #'+lubricy:kill-all-buffers)
(ex! "k[ill]m"     #'+lubricy:kill-matching-buffers)
